...
namespace MovieQuery.Controllers
{
    public class PlatformsController : Controller
    {
        ...
        public PlatformsController(MQDatabaseContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Title")] Platform platform)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title")] Platform platform)
        {
            if (id != platform.Id)
            {
                return NotFound();
